...
public class Global
{
    ...
    // HeyGe custom distribution: this is an explicit customer-facing
    // navigation entry, not the upstream promotion destination.
    public const string PromotionUrl = @"https://sxcrs.com";
